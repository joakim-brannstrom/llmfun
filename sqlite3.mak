...
build/sqlite3.stamp:
	mkdir -p build
	$(CC) -c -O2 -DSQLITE_THREADSAFE=1 -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_ENABLE_UNLOCK_NOTIFY -DSQLITE_ENABLE_FTS5 vendor/sqlite3/sqlite3.c -o build/sqlite3.o
