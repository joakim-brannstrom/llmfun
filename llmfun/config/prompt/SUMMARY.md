...
Be specific about facts and decisions, but concise. Aim for 150-350 words for the summary field. The entire response must fit within 4096 tokens.

The answer **shall** be only Markdown text containing the answer (summary).
